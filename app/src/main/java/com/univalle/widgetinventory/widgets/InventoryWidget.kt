...
import com.univalle.widgetinventory.view.fragment.InventoryHomeFragment
...
class InventoryWidget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action == "TOGGLE_EYE") {
            ...
            if (isUserLogged(context!!)) {
                val inventory = Intent(context, InventoryHomeFragment::class.java).apply {
    ...
    internal fun updateAppWidget(
        ...
        intentEye.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId)
